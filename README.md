...
| `yomu.font.codeFamily` | (empty) | Font for code. Empty means a Latin monospace font (Cascadia Mono, Consolas, Menlo, ...) with the editor font for Japanese, so box-drawing diagrams line up. |
