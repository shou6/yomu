...
- Focus mode: dims everything except the block you are reading (about 40% down the screen). Turn it on with `yomu.focusMode` or the command "Yomu: Toggle Focus Mode".
